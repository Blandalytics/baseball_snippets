        ...
        for game in x["dates"][0]["games"]:
            if "rescheduleGameDate" in list(game.keys()):
                if game["rescheduleGameDate"] != date:
                    continue
            if game["status"]["detailedState"] in ["Pre-Game", "Warmup", "Scheduled", "Postponed"]:
                continue
...
def game_chart(game_choice_id):
    ...
    home_rect2 = patches.Rectangle((-0.675, 0.88), width=game_abs * 0.105,
                                  height=0.24, facecolor="w",zorder=10,
                                  linewidth=0,
                                #  boxstyle="round",
    ...
    away_rect2 = patches.Rectangle((-0.675, -0.1245), width=game_abs * 0.105,
                                  height=0.24, facecolor="w",zorder=10,
                                  linewidth=0,
                                #  boxstyle="round",
                                 edgecolor=pl_background)
    ...
    fig.text(0.415,0.92,f"{away_name} @ {home_name}", color=pl_text, fontsize=25,ha="center",va="top")
    fig.text(
        0.415,
        0.79,
