...
def game_chart(game_choice_id):
    ...
    home_rect2 = patches.Rectangle((-0.6, 0.881), width=game_abs * 0.105,
                                  height=0.2385, facecolor="w",zorder=10,
                                  linewidth=0,
                                #  boxstyle="round",
    ...
    away_rect2 = patches.Rectangle((-0.6, -0.1225), width=game_abs * 0.105,
