...
medal_dict = {
    ...
    'Bronze':[fig.add_axes([0.625,.8,0.2,0.2], anchor='SW', zorder=2), gold_vs_silver_weight*silver_vs_bronze_weight, '#977547']
}
...
fig.suptitle('Olympic Medal Leaders',fontsize=18,y=1.025)
