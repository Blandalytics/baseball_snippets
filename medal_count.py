...
medal_dict = {
    'Gold':[fig.add_axes([0.09,.81,0.2,0.2], anchor='SW', zorder=2), 1, '#fcb434'],
    'Silver':[fig.add_axes([0.3,.81,0.2,0.2], anchor='SW', zorder=2), gold_vs_silver_weight, '#d6d6d6'],
    'Bronze':[fig.add_axes([0.525,.81,0.2,0.2], anchor='SW', zorder=2), gold_vs_silver_weight*silver_vs_bronze_weight, '#977547']
}
...
fig.text(0.25,0.95,'=       =',ha='left',va='top',fontsize=32)
