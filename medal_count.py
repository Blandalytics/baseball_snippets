...
medal_dict = {
    'Gold':[fig.add_axes([0.19,.825,0.2,0.2], anchor='SW', zorder=2), 1, '#fcb434'],
    'Silver':[fig.add_axes([0.4,.825,0.2,0.2], anchor='SW', zorder=2), gold_vs_silver_weight, '#d6d6d6'],
    'Bronze':[fig.add_axes([0.625,.825,0.2,0.2], anchor='SW', zorder=2), gold_vs_silver_weight*silver_vs_bronze_weight, '#977547']
}
...
fig.text(0.5,0.965,'=      =',ha='center',va='top',fontsize=36)
