...
medal_dict = {
    'Gold':[fig.add_axes([0.19,.81,0.2,0.2], anchor='SW', zorder=2), 1, '#fcb434'],
    'Silver':[fig.add_axes([0.4,.81,0.2,0.2], anchor='SW', zorder=2), gold_vs_silver_weight, '#d6d6d6'],
    'Bronze':[fig.add_axes([0.625,.81,0.2,0.2], anchor='SW', zorder=2), gold_vs_silver_weight*silver_vs_bronze_weight, '#977547']
}
for color in medal_dict.keys():
    ...
    medal_ax.set(xlim=(medal_ax.get_xlim()[0]-1.5,medal_ax.get_xlim()[1]+1.5),
                 ylim=(medal_ax.get_xlim()[0]-1.5,medal_ax.get_xlim()[1]+1.5),)
    medal_ax.axis('off')
