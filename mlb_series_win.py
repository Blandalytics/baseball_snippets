...
st.write(f'[Log 5 Win% Estimate](https://web.williams.edu/Mathematics/sjmiller/public_html/103/Log5WonLoss_Paper.pdf): (favorite_win_prob - (favorite_win_prob * underdog_win_prob)) / (favorite_win_prob + underdog_win_prob - (2 * favorite_win_prob * underdog_win_prob))')
