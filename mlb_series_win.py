...
st.write(f'[PythagenPat Run Environment exponent](https://legacy.baseballprospectus.com/glossary/index.php?mode=viewstat&stat=136):'+r'$(\frac{runs_{\text{scored}} + runs_{\text{allowed}}}{game})^{.285}$')
