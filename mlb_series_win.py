...
st.write(f'[Pythagorean Team Win% Estimate](https://www.mlb.com/glossary/advanced-stats/pythagorean-winning-percentage): '+r'Win%_{\text{pyth}} = $(\frac{}{runs_{\text{scored}}^{exp}+runs_{\text{allowed}}^{exp}})$')
